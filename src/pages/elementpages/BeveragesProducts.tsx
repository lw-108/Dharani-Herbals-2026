...
const products = [
  ...
  },
  {
    ...
    reviews: null,
    price: "₹116",
    image: "/products/nannari-sherbet.png",
    category: "BEVERAGES",
    brand: "VANA ARASI",
    type: "popular",
  },
  ...
  {
    id: 6,
    name: "VADHASURA KUDINEER CHURNAM",
    tag: "Popular",
    rating: null,
    reviews: null,
    price: "₹122",
    image: "/products/vadhasura-kudineer-churnam.png",
    category: "BEVERAGES",
    brand: "VEDAN",
    type: "popular",
  },
  {
    ...
    reviews: null,
    price: "₹35 - ₹65",
    image: "/products/dry-ginger-coffee.png",
    category: "BEVERAGES",
    brand: "ATHIYAMAN",
    type: "popular",
  },
  ...
  {
    id: 9,
    name: "HIBISCUS (CHEMPARUTHI) TEA POWDER",
    tag: "Popular",
    rating: null,
    reviews: null,
    price: "₹65",
    image: "/products/hibiscus-tea-powder.png",
    category: "BEVERAGES",
    brand: "MAKIL",
    type: "popular",
  },
  {
    id: 10,
    name: "Thirikadugu Tea",
    tag: "Popular",
    rating: null,
    reviews: null,
    price: "₹55",
    image: "/products/thirikadugu-tea.png",
    category: "BEVERAGES",
    brand: "RAMCARE",
    type: "popular",
  },
  ...
  },
  {
    ...
    reviews: null,
    price: "₹80",
    image: "/products/green-tea-jar.png",
    category: "BEVERAGES",
    brand: "VEDAN AMUTHU",
    type: "deals",
  },
  {
    id: 14,
    name: "SUKKU POWDER (PO)",
    tag: "Popular",
    rating: null,
    reviews: null,
    price: "₹50",
    image: "/products/sukku-powder.png",
    category: "BEVERAGES",
    brand: "VEDAN",
    type: "popular",
  },
...
const BeveragesProducts = () => {
  ...
  const hasActiveFilters = selectedCategory !== "BEVERAGES" || selectedBrand !== "All Brands" || selectedType !== "all";

  return (
    <section className="relative bg-[#0a0f09] min-h-screen py-8 md:py-12">
      {/* Background Effects */}
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-amber-500/3 rounded-full blur-3xl" />
        <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-yellow-500/3 rounded-full blur-3xl" />
      </div>
          ...
          >
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="lg:hidden flex items-center gap-2 px-4 py-2.5 bg-amber-500/10 border border-amber-500/20 rounded-xl text-amber-400 text-sm font-medium hover:bg-amber-500/20 transition-colors"
              >
              ...
              <>
                ...
                >
                  <div className="p-6">
                    ...
                    <button
                      onClick={clearAllFilters}
                      className="text-sm text-amber-400 hover:text-amber-300 mb-6"
                    >
                      Clear All Filters
                    </button>
          ...
          <motion.div layout className="flex-1">
            ...
            {hasActiveFilters && (
              ...
              >
                ...
                {selectedCategory !== "BEVERAGES" && (
                  <span className="inline-flex items-center gap-1 px-3 py-1 rounded-full bg-amber-500/10 text-amber-400 text-xs border border-amber-500/20">
                    {selectedCategory}
            ...
            >
              <AnimatePresence mode="popLayout">
                {sortedProducts.map((product, index) => (
                  ...
                  >
                    <div className="relative h-full bg-white/[0.02] backdrop-blur-sm rounded-2xl border border-white/5 hover:border-amber-500/20 transition-all duration-500 overflow-hidden hover:shadow-2xl hover:shadow-amber-500/5">
                      {/* Product Image */}
                            ...
                            >
                              <div className="absolute bottom-4 left-4 right-4 flex gap-2">
                                <motion.button
                                  ...
                                  exit={{ y: 20, opacity: 0 }}
                                  className="flex-1 flex items-center justify-center gap-2 bg-white text-gray-900 px-4 py-2.5 rounded-xl text-sm font-semibold hover:bg-amber-500 hover:text-white transition-colors"
                                >
                      ...
                      <div className="p-5">
                        ...
                        {/* Product Name */}
                        <h3 className="text-sm font-semibold text-white group-hover:text-amber-400 transition-colors mb-1 line-clamp-2">
                          {product.name}
                        </h3>
                        ...
                        <div className="flex items-center gap-2">
                          <motion.button
                            ...
                            className={`flex-1 flex items-center justify-center gap-2 px-3 py-2 rounded-xl text-xs font-semibold transition-all duration-300 ${
                              addedToCart.includes(product.id)
                                ...
                                : "bg-white/5 text-gray-400 hover:bg-amber-500 hover:text-white border border-white/10"
                            }`}
                          >
                          ...
                          <motion.button
                            ...
                            className="px-4 py-2 rounded-xl bg-gradient-to-r from-amber-500 to-orange-500 text-white text-xs font-semibold hover:shadow-lg hover:shadow-amber-500/25 transition-all"
                          >
                            Buy Now
                          </motion.button>
                        </div>
                      ...
                      <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-700 pointer-events-none rounded-2xl overflow-hidden">
                        <div className="absolute inset-0 bg-gradient-to-tr from-transparent via-amber-500/5 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-1000" />
                      </div>
                    </div>
                  </motion.div>
                ))}
            ...
            {filteredProducts.length === 0 && (
              ...
              >
                ...
                <p className="text-gray-400 text-lg">No beverages found matching your filters.</p>
                <button
                  onClick={clearAllFilters}
